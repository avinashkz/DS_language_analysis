...
b <- bar_plot(responses[,c(1,5)], 1, plot_title, colnames(responses[,1]))

#Coding experience
#proportion_plot(responses[,c(4,5)], 4, plot_title, colnames(responses[,4]))
ce <- bar_plot(responses[,c(2,5)], 2, plot_title, colnames(responses[,2]), flip = FALSE) + 
  ggtitle("Coding Experience") +
...
#proportion_plot(responses[,c(4,5)], 4, plot_title, colnames(responses[,4]))
ca <- bar_plot(responses[,c(3,5)], 3, plot_title, colnames(responses[,3]), flip = FALSE) +
   ggtitle("Attitude towards coding") +
    theme(axis.text.x = element_text(angle=45, vjust=0.5), 
          plot.title = element_text(hjust = 0, size = 12)) +
  xlab("")
...
#proportion_plot(responses[,c(4,5)], 4, plot_title, colnames(responses[,4]))
fl <- bar_plot(responses[,c(4,5)], 4, plot_title, colnames(responses[,4]), flip = FALSE) +
  ggtitle("First Programming Language") +
    theme(axis.text.x = element_text(angle=45, vjust=0.5), 
          plot.title = element_text(hjust = 0, size = 12)) +
  xlab("")
...
al <- bar_plot(responses[,c(7,5)], 7, plot_title, colnames(responses[,7]), flip = FALSE) +
  ggtitle("Number of Languages actively Used") +
    theme(axis.text.x = element_text(angle=45, vjust=0.5), 
          plot.title = element_text(hjust = 0, size = 12)) +
  xlab("")
