...
survey_analysis$academic <- str_replace(tolower(survey_analysis$academic),".*science.*","science")

# Creating a vector, putting all the fields to others 

survey_clean_1 <- c("business","computer","engineering","science","Mathematics / Statistics")
